...
namespace triqs {
  ...
  */
    class tight_binding {
      ...
      friend void h5_write(triqs::h5::group h5group, std::string subgroup_name, tight_binding const &tb) {
      ...
      CPP2PY_IGNORE
      static tight_binding h5_read_construct(triqs::h5::group h5group, std::string subgroup_name) {
